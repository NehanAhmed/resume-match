...
import { ArrowLeft, CheckCircle, XCircle, AlertCircle, FileText, Sparkles, Loader2, Save, UserPlus, Download } from "lucide-react"
...
## Missing Keywords
The following keywords were found in the job description but missing from your resume:
...
`
    ...
    a.href = url
    a.download = `resume-analysis-${data.resumeFileName.replace(/\.[^/.]+$/, '')}.md`
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Here is how well your resume aligns with this job posting
            </p>
          </div>
          ...
          <Card className="p-6 mb-6">
            <h3 className="text-lg font-semibold mb-4">Keywords to Add</h3>
            <p className="text-sm text-muted-foreground mb-4">
              These terms appear in the job posting but are missing from your resume. Adding them will improve your match score:
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button variant="outline" size="lg" onClick={handleDownloadReport} className="flex items-center gap-2">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center gap-2 justify-center md:justify-start mb-2">
                    ...
                    <h3 className="text-lg font-semibold">Save This Analysis</h3>
                  </div>
                  <p className="text-sm text-muted-foreground mb-1">
                    Create a free account to save your results and track your progress over time.
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Without an account, this analysis will be lost when you leave this page.
                  </p>
                </div>
